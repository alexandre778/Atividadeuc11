...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    try {
        ...
        // Verifica se o ID é válido (positivo)
        if (produtoId > 0) {
            ProdutosDAO produtosDAO = new ProdutosDAO();
            produtosDAO.venderProduto(produtoId);  // Chama o método que atualiza o status no banco

            // Atualiza a interface gráfica (tabela) para refletir a mudança
            listarProdutos();  // Recarrega a lista de produtos para mostrar o novo status
        } else {
            JOptionPane.showMessageDialog(null, "ID inválido. O ID deve ser maior que 0.");
        }
